...
class Author
{
    ...
    #[Assert\Length(min:3, max: 255, minMessage: "Le nom de l'auteur doit faire au moins 3 caractères", maxMessage:"Le nom de l'auteur ne peut pas faire plus de 255 caractères")]
